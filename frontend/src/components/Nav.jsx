...
const Nav = () => {
    ...
    const liStyle = 'font-semibold text-md md:text-base mx-2 drop-shadow-[0_2px_1px_rgba(0,0,0,0.25)] hover:drop-shadow-[0_4px_1px_rgba(0,0,0,0.25)] transition duration-5s'
  return (
    <div className='w-full flex flex-wrap flex-row justify-between items-end'>
     <img src={daLogo} alt="drivers addiction logo" className='w-full sm:w-40 lg:w-55 h-35' />
        ...
        <h3><Link className='font-medium text-md md:text-base mx-1 flex flex-row text-center drop-shadow-[0_2px_1px_rgba(0,0,0,0.25)] hover:drop-shadow-[0_4px_1px_rgba(0,0,0,0.25)] transition duration-5s'>login<br />Signup</Link></h3>
    </div>
  )
