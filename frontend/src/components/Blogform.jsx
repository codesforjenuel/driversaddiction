...
const Blogform = () => {
 ...
 <input type="text" name="profile" value={profileImage} className=' border-2 border-solid border-slate-500 rounded-md mb-5' required onChange={(event) => setProfileImage(event.target.value)}/>
 <label htmlFor="name">Driver's Name</label>
 <input type="text" name="name" value={driversName} className=' border-2 border-solid border-slate-500 rounded-md mb-5' required onChange={(event) => setDriversName(event.target.value)}/>
 <label htmlFor="bio">Bio</label>
 <input type="text" name="bio" value={driverBio} className=' border-2 border-solid border-slate-500 rounded-md mb-5' required onChange={(event) => setDriverBio(event.target.value)}/>
